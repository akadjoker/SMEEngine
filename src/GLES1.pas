...
var
{$IFDEF UNIX}
 CONV_LibHandle:   EsHandle=nil;
  {$ELSE}
 CONV_LibHandle:   EsHandle=0;
{$ENDIF}


function convLoadLibrary(Name: PChar):  EsHandle;
begin
  {$IFDEF UNIX}
   CONV_LibHandle :=nil;
...
function convGetProcAddress(ProcName: string; LibHandle:  EsHandle = 0): Pointer;
begin

   {$IFDEF UNIX}


    if LibHandle = nil then    LibHandle := CONV_LibHandle;
     ...
     begin
      ...
      if Result=nil then
      Result := dlsym(LibHandle, pchar(ProcName+'OES'));

      if assigned(result) then
        logmsg('Load :'+ProcName);

     end;

     {$ELSE}

    if LibHandle = 0 then    LibHandle := CONV_LibHandle;
     ...
     begin
      ...
      Result := GetProcAddress(LibHandle, Pchar(ProcName+'OES'));
             if assigned(result) then writeln('Load :'+ProcName);
     end;
   {$ENDIF}
...
begin
  ...
  if CONV_LibHandle <> nil then  convFreeLibrary(CONV_LibHandle);
  CONV_LibHandle := convLoadLibrary(PChar(LibName));
  if CONV_LibHandle = nil then exit;
...
glActiveTexture:= ConvGetProcAddress('glActiveTexture');
glAlphaFunc:= ConvGetProcAddress('glAlphaFunc');
glAlphaFuncx:= ConvGetProcAddress('glAlphaFuncx');
glBindTexture:= ConvGetProcAddress('glBindTexture');
glBlendFunc:= ConvGetProcAddress('glBlendFunc');
glClear:= ConvGetProcAddress('glClear');
glClearColor:= ConvGetProcAddress('glClearColor');
glClearColorx:= ConvGetProcAddress('glClearColorx');
glClearDepthf:= ConvGetProcAddress('glClearDepthf');
glClearDepthx:= ConvGetProcAddress('glClearDepthx');
glClearStencil:= ConvGetProcAddress('glClearStencil');
glClientActiveTexture:= ConvGetProcAddress('glClientActiveTexture');
glColor4f:= ConvGetProcAddress('glColor4f');
glColor4x:= ConvGetProcAddress('glColor4x');
glColorMask:= ConvGetProcAddress('glColorMask');
glColorPointer:= ConvGetProcAddress('glColorPointer');
glCompressedTexImage2D:= ConvGetProcAddress('glCompressedTexImage2D');
glCompressedTexSubImage2D:= ConvGetProcAddress('glCompressedTexSubImage2D');
glCopyTexImage2D:= ConvGetProcAddress('glCopyTexImage2D');
glCopyTexSubImage2D:= ConvGetProcAddress('glCopyTexSubImage2D');
glCullFace:= ConvGetProcAddress('glCullFace');
glDeleteTextures:= ConvGetProcAddress('glDeleteTextures');
glDepthFunc:= ConvGetProcAddress('glDepthFunc');
glDepthMask:= ConvGetProcAddress('glDepthMask');
glDepthRangef:= ConvGetProcAddress('glDepthRangef');
glDepthRangex:= ConvGetProcAddress('glDepthRangex');
glDisable:= ConvGetProcAddress('glDisable');
glDisableClientState:= ConvGetProcAddress('glDisableClientState');
glDrawArrays:= ConvGetProcAddress('glDrawArrays');
glDrawElements:= ConvGetProcAddress('glDrawElements');
glEnable:= ConvGetProcAddress('glEnable');
glEnableClientState:= ConvGetProcAddress('glEnableClientState');
glFinish:= ConvGetProcAddress('glFinish');
glFlush:= ConvGetProcAddress('glFlush');
glFogf:= ConvGetProcAddress('glFogf');
glFogfv:= ConvGetProcAddress('glFogfv');
glFogx:= ConvGetProcAddress('glFogx');
glFogxv:= ConvGetProcAddress('glFogxv');
glFrontFace:= ConvGetProcAddress('glFrontFace');
glFrustumf:= ConvGetProcAddress('glFrustumf');
glFrustumx:= ConvGetProcAddress('glFrustumx');
glGenTextures:= ConvGetProcAddress('glGenTextures');
glGetError:= ConvGetProcAddress('glGetError');
glGetIntegerv:= ConvGetProcAddress('glGetIntegerv');
glHint:= ConvGetProcAddress('glHint');
glLightModelf:= ConvGetProcAddress('glLightModelf');
glLightModelfv:= ConvGetProcAddress('glLightModelfv');
glLightModelx:= ConvGetProcAddress('glLightModelx');
glLightModelxv:= ConvGetProcAddress('glLightModelxv');
glLightf:= ConvGetProcAddress('glLightf');
glLightfv:= ConvGetProcAddress('glLightfv');
glLightx:= ConvGetProcAddress('glLightx');
glLightxv:= ConvGetProcAddress('glLightxv');
glLineWidth:= ConvGetProcAddress('glLineWidth');
glLineWidthx:= ConvGetProcAddress('glLineWidthx');
glLoadIdentity:= ConvGetProcAddress('glLoadIdentity');
glLoadMatrixf:= ConvGetProcAddress('glLoadMatrixf');
glLoadMatrixx:= ConvGetProcAddress('glLoadMatrixx');
glLogicOp:= ConvGetProcAddress('glLogicOp');
glMaterialf:= ConvGetProcAddress('glMaterialf');
glMaterialfv:= ConvGetProcAddress('glMaterialfv');
glMaterialx:= ConvGetProcAddress('glMaterialx');
glMaterialxv:= ConvGetProcAddress('glMaterialxv');
glMatrixMode:= ConvGetProcAddress('glMatrixMode');
glMultMatrixf:= ConvGetProcAddress('glMultMatrixf');
glMultMatrixx:= ConvGetProcAddress('glMultMatrixx');
glMultiTexCoord4f:= ConvGetProcAddress('glMultiTexCoord4f');
glMultiTexCoord4x:= ConvGetProcAddress('glMultiTexCoord4x');
glNormal3f:= ConvGetProcAddress('glNormal3f');
glNormal3x:= ConvGetProcAddress('glNormal3x');
glNormalPointer:= ConvGetProcAddress('glNormalPointer');
glOrthof:= ConvGetProcAddress('glOrthof');
glOrthox:= ConvGetProcAddress('glOrthox');
glPixelStorei:= ConvGetProcAddress('glPixelStorei');
glPointSize:= ConvGetProcAddress('glPointSize');
glPointSizex:= ConvGetProcAddress('glPointSizex');
glPolygonOffset:= ConvGetProcAddress('glPolygonOffset');
glPolygonOffsetx:= ConvGetProcAddress('glPolygonOffsetx');
glPopMatrix:= ConvGetProcAddress('glPopMatrix');
glPushMatrix:= ConvGetProcAddress('glPushMatrix');
glReadPixels:= ConvGetProcAddress('glReadPixels');
glRotatef:= ConvGetProcAddress('glRotatef');
glRotatex:= ConvGetProcAddress('glRotatex');
glSampleCoverage:= ConvGetProcAddress('glSampleCoverage');
glSampleCoveragex:= ConvGetProcAddress('glSampleCoveragex');
glScalef:= ConvGetProcAddress('glScalef');
glScalex:= ConvGetProcAddress('glScalex');
glScissor:= ConvGetProcAddress('glScissor');
glShadeModel:= ConvGetProcAddress('glShadeModel');
glStencilFunc:= ConvGetProcAddress('glStencilFunc');
glStencilMask:= ConvGetProcAddress('glStencilMask');
glStencilOp:= ConvGetProcAddress('glStencilOp');
glTexCoordPointer:= ConvGetProcAddress('glTexCoordPointer');
glTexEnvf:= ConvGetProcAddress('glTexEnvf');
glTexEnvfv:= ConvGetProcAddress('glTexEnvfv');
glTexEnvx:= ConvGetProcAddress('glTexEnvx');
glTexEnvxv:= ConvGetProcAddress('glTexEnvxv');
glTexImage2D:= ConvGetProcAddress('glTexImage2D');
glTexParameterf:= ConvGetProcAddress('glTexParameterf');
glTexParameterx:= ConvGetProcAddress('glTexParameterx');
glTexSubImage2D:= ConvGetProcAddress('glTexSubImage2D');
glTranslatef:= ConvGetProcAddress('glTranslatef');
glTranslatex:= ConvGetProcAddress('glTranslatex');
glVertexPointer:= ConvGetProcAddress('glVertexPointer');
glViewport:= ConvGetProcAddress('glViewport');
glDeleteFramebuffers:= ConvGetProcAddress('glDeleteFramebuffers');
glGetString:= ConvGetProcAddress('glGetString');
glTexEnvi:= ConvGetProcAddress('glTexEnvi');
glTexParameteri:= ConvGetProcAddress('glTexParameteri');

  //EGL
eglGetProcAddress:= ConvGetProcAddress('eglGetProcAddress');
eglGetError:= ConvGetProcAddress('eglGetError');
eglGetDisplay:= ConvGetProcAddress('eglGetDisplay');
eglInitialize:= ConvGetProcAddress('eglInitialize');
eglTerminate:= ConvGetProcAddress('eglTerminate');
eglGetConfigs:= ConvGetProcAddress('eglGetConfigs');
eglChooseConfig:= ConvGetProcAddress('eglChooseConfig');
eglGetConfigAttrib:= ConvGetProcAddress('eglGetConfigAttrib');
eglCreateWindowSurface:= ConvGetProcAddress('eglCreateWindowSurface');
eglCreatePbufferSurface:= ConvGetProcAddress('eglCreatePbufferSurface');
eglCreatePixmapSurface:= ConvGetProcAddress('eglCreatePixmapSurface');
eglDestroySurface:= ConvGetProcAddress('eglDestroySurface');
eglQuerySurface:= ConvGetProcAddress('eglQuerySurface');
eglBindAPI:= ConvGetProcAddress('eglBindAPI');
eglQueryAPI:= ConvGetProcAddress('eglQueryAPI');
eglWaitClient:= ConvGetProcAddress('eglWaitClient');
eglReleaseThread:= ConvGetProcAddress('eglReleaseThread');
eglCreatePbufferFromClientBuffer:= ConvGetProcAddress('eglCreatePbufferFromClientBuffer');
eglSurfaceAttrib:= ConvGetProcAddress('eglSurfaceAttrib');
eglBindTexImage:= ConvGetProcAddress('eglBindTexImage');
eglReleaseTexImage:= ConvGetProcAddress('eglReleaseTexImage');
eglSwapInterval:= ConvGetProcAddress('eglSwapInterval');
eglCreateContext:= ConvGetProcAddress('eglCreateContext');
eglDestroyContext:= ConvGetProcAddress('eglDestroyContext');
eglMakeCurrent:= ConvGetProcAddress('eglMakeCurrent');
eglGetCurrentContext:= ConvGetProcAddress('eglGetCurrentContext');
eglGetCurrentSurface:= ConvGetProcAddress('eglGetCurrentSurface');
eglGetCurrentDisplay:= ConvGetProcAddress('eglGetCurrentDisplay');
eglQueryContext:= ConvGetProcAddress('eglQueryContext');
eglWaitGL:= ConvGetProcAddress('eglWaitGL');
eglWaitNative:= ConvGetProcAddress('eglWaitNative');
eglSwapBuffers:= ConvGetProcAddress('eglSwapBuffers');
eglCopyBuffers:= ConvGetProcAddress('eglCopyBuffers');
